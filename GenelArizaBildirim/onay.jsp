...
<%
 ...
 Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/musteri","root","fides");  
    ...
    String bolge="MOBESE";
      ...
      sorgu="select * from kayit where onay=10 and bolge=? and sikayeti_alan=? order by kayit_tarihi desc";
  ...
  <th>Geri Gönder</th>
   ...
   <% while(sonuc.next()) { %>
    <tr>
            ...
            <td><%=sonuc.getString("sikayetci")%></td>
 <%
        ...
        DateFormat df=new SimpleDateFormat("dd-MM-yyyy");
            ...
            <td><a href="onay.jsp?onay=<%=sonuc.getInt("mid")%>">Onay</a></td>
            <td><a href="onay.jsp?red=<%=sonuc.getInt("mid")%>">Geri Gönder</a></td>
