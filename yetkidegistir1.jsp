...
<html>
    ...
    <body>
        ...
        <%
            ...
            String teklifv=request.getParameter("teklif");
int id =Integer.parseInt(request.getParameter("a"));
            ...
            PreparedStatement sorgulama=con.prepareStatement("update kullanicilar set username=?,sifre=?,bilgiler=?,ekleme=?,degistirme=?,raporlama=?,projeekle=?,projeduzelt=?,projesil=?,faturakes=?,teklif=? where kullaniciid=? ");
            ...
            sorgulama.setInt(12,id);
            sorgulama.executeUpdate();
               %>

               <script>
                  alert("De?i?tirilmi?tir");
                   </script>
                   <% 
