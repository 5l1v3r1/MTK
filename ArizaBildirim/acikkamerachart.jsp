...
con.close();
          ...
          Class.forName("com.mysql.jdbc.Driver").newInstance();  
 Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/musteri","root","fides");  
 String query="select count(*) as sayi from kayit where bolge='TELEKOM' and sistem='kamera' and onay!=2 and onay!=3";
  String query2="select kamera from istatistik";
...
//select count(*) from kayit where onay!=2 and bolge='TELEKOM' and sistem='kamera';
		...
		boolean urls = true;
		 ...
		 chart = ChartFactory.createPieChart("ARIZALI KAMERA YUZDESI", dataset, true, true, true);
