...
String subject = "Arıza giderilmiştir";
String SSL_FACTORY;
		SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";                
String messageText = "Arızanız giderilmiştir.Lütfen MTK yazılımına girerek arızaya onay veriniz.Aksi halde bu arıza ,Açık Arızalar listesinde listelenmeye devam eder.";
