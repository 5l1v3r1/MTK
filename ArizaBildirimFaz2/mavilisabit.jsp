...
<body>
    ...
    if(request.getParameter("btn_submit")==null)
    {
        ...
        %>
       <h3 align="center">MAVİLİ SABİT TİP ARIZA KAYIT</h1>
    ...
    --%>
      ...
      <form name="uploadForm" action="dee.jsp" enctype="multipart/form-data" method="post">
       ...
       %>
                ...
                <br>
                <br>
    <form  action="mavilisabit.jsp" method=post name="a" onsubmit="return check()">
                 <table  border="1" align="center">
 ...
 ResultSet rs = stmt.executeQuery("Select ariza  from arizatipi where tip='Sabit Tip'");
      ...
      if(onemli.getValue("upload")!=null)
       ...
       String tip=request.getParameter("country");
           ...
           String sorgu = "insert into kayit (firma_adi,projeno,kayit_tarihi,kayit_saati,sikayetci,tel,sorun,sikayeti_alan,onay,antlasma,garanti,iscinsi,eleman,randevu,bolge,lokasyon,sistem,arizatipi,filename,onem,sirket) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            sorgulama.setString(17, "Sabit Tip");
