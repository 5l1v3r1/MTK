...
<table border="1" align="center">
      ...
      <td><select style="width: 360px" name="sistem">
            ...
            <option value="Gazli Sondurme">Gazli Sondurme</option>
            <option value="Yangin Algilama">Yangin Algilama</option>
            <option value="Hirsiz Alarm">Hirsiz Alarm</option>
            <option value="Hybrid kamera">Hybrid kamera</option>
            <option value="Sabit Tip">Sabit Tip</option>
...
if (company!=1){  %>
      ...
      <th>Firma </th>
      <td><select  style="width: 360px" name="firma">
            <option value="0">Hepsi</option>
            <option value="fides">Fides</option>
     <option value="palmet">Palmet</option>
     <option value="nitel">Nitel</option>
     <option value="mavili">Mavili</option>
    ...
    <input type="hidden" name="firma" value="0"></input>
    <%
}
