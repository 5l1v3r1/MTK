...
<body>
    ...
    if(request.getParameter("btn_submit")==null)
    {
        ...
        %>
       <h3 align="center">FİDES KGS ARIZA KAYIT</h1>
    ...
    --%>
      ...
      <form name="uploadForm" action="dee.jsp" enctype="multipart/form-data" method="post">
       ...
       %>
                ...
                <br>
                <br>
    <form  action="fideskgs.jsp" method=post name="a" onsubmit="return check()">
                 <table  border="1" align="center">
 ...
 ResultSet rs = stmt.executeQuery("Select ariza  from arizatipi where tip='kgs'");
  ...
  String file="";
   ...
   int pre=Integer.parseInt(request.getParameter("pre"));
        ...
        if(pre==1)
       {
           ...
           pree="Panel Offline > Panele Ping Atılabiliyor";
       }
              if(pre==4)
       {
           
           pree="Panel Offline > Panele Ping Atılamıyor > Panel Enerjisi Var > Ethernet Kablosu Işığı Yanıyor > Switch Port Ayarlarında Değişiklik Yapılmadı";
       }
             if(pre==7)
       {
           
           pree="Geçiş Arızası > Panel Online > Kart Okutulduğunda Sisteme Log Düşmüyor";
       }
                if(pre==9)
       {
           
           pree="Geçiş Arızası > Panel Online > Kart Okutulduğunda Sisteme Log Düşüyor > Access Granted Logu Düşüyor";
       }
