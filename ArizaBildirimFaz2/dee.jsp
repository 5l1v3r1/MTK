		    ...
		    for (int i = 0; i < 5; i++)
		    {
		        text[i] = characters.charAt(rng.nextInt(characters.length()));
                    ...
                    String extension=result[1];
                        ...
                        lastFileName = fileName;
                     //  buffer = new java.io.FileOutputStream("/var/lib/tomcat/webapps/MTK/ArizaBildirimFaz2/uploads/" + fileName);
                    //  buffer = new java.io.FileOutputStream("D:\\projelerim\\MTK\\build\\web\\ArizaBildirimFaz2\\uploads\\" + fileName);
              buffer = new java.io.FileOutputStream("C:\\Program Files (x86)\\Apache Software Foundation\\Tomcat 6.0\\webapps\\MTK\\ArizaBildirimFaz2\\uploads\\" + fileName);
