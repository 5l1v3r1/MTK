...
<body>
    ...
    if(request.getParameter("btn_submit")==null)
    {
        ...
        %>
       <h3 align="center">PALMET GAZLI SÖNDÜRME ARIZA KAYIT</h1>
    ...
    --%>
      ...
      <form name="uploadForm" action="dee.jsp" enctype="multipart/form-data" method="post">
       ...
       %>
                ...
                <br>
                <br>
    <form  action="palmetgazli.jsp" method=post name="a" onsubmit="return check()">
                 <table  border="1" align="center">
 ...
 ResultSet rs = stmt.executeQuery("Select ariza  from arizatipi where tip='Gazli Sondurme'");
